...
public abstract class BaseTest {
    ...
    private final JLupinDelegator jLupinQueueDelegator;
    ...
    public BaseTest() {
        ...
        jLupinQueueDelegator = JLupinClientUtil.generateOuterClientLoadBalancerDelegator(
                HOW_OFTEN_CHECKING_SERVER_IN_MILLIS,
                REPEATS_AMOUNT,
                CHANGE_SERVER_INTERVAL_IN_MILLIS,
                PortType.QUEUE,
    ...
    public JLupinDelegator getJLupinQueueDelegator() {
        return jLupinQueueDelegator;
    }
}